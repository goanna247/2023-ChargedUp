...
void Robot::RobotInit() {
  ...
  intake->SetDefaultBehaviour([this]() {
    return make<IntakeBehaviour>(intake, &map.controllers.driver, &map.controllers.coDriver);
  })
...
void Robot::TeleopPeriodic() { 
  ...
  // double armSpeed = map.controllers.codriver.GetRightY();
  // double elevator = map.controllers.codriver.GetLeftY();
