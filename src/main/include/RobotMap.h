...
struct RobotMap {
  ...
  struct SwerveBase{
    ...
    wpi::array<wom::SwerveModuleConfig, 4> moduleConfigs{
      wom::SwerveModuleConfig{ // dimensions are assuming perfect square robot 1m^2 area
        frc::Translation2d(0.255714_m, 0.242948_m),
        wom::Gearbox{
  ...
  struct IntakeSystem {
    WPI_TalonSRX intakeMotor1{99};
    WPI_TalonSRX intakeMotor2{99}; 

    wom::MotorVoltageController intakeMotorGroup = wom::MotorVoltageController::Group(intakeMotor1, intakeMotor2);
